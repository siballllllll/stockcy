...
const OWNER_LABEL: Record<string, string> = {
  ...
  SHADOW_G: "⚡ 섀도우 G — 촉매 모멘텀 (3거래일)",
  SHADOW_H: "⚡ 섀도우 H — 촉매 모멘텀 (7거래일)",
  // [v3.191.0] 추매 짝 — 진입은 원본과 동일하고 추매만 다르다.
  SHADOW_A2: "➕ 섀도우 A2 — 눌림목 + 근거유지 추매",
  SHADOW_F2: "➕ 섀도우 F2 — 모멘텀 + 근거유지 추매",
  SHADOW_D2: "➕ 섀도우 D2 — 수급 + 근거유지 추매",
};
