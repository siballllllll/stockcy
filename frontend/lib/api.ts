...
export const api = {
  ...
  portfolio: {
    ...
    marketCalendar: (market = "KR")           => req<{ ok?: boolean; error?: string; date?: string | null; is_open?: boolean; next_business_day?: string | null; prev_business_day?: string | null }>(`/api/market/calendar?market=${market}`),
