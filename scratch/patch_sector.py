...
target_kr = """                                with st.container(height=600):
...
# US Sector Replacement
target_us = """                                with st.container(height=600):
                                    for sub_name, stocks in subsectors.items():
...
content = content.replace(target_kr, replacement_kr)
content = content.replace(target_us, replacement_us)
