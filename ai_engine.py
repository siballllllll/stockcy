...
def _deep_dive_issue(stub: dict) -> dict:
    ...
    prompt = (
        ...
        "【확률 규칙】 A+B=100. 근거가 한쪽에 기울면 과감하게 벌리고(5~95), 팽팽하면 50/50이라고 정직하게 쓰세요 — "
        "억지로 벌린 숫자나 정밀해 보이려 꾸민 끝자리는 나중에 실제 적중률과 대조해 검증되므로 무의미합니다.\n\n"
...
def analyze_custom_issue(keyword: str) -> dict:
    ...
    prompt = (
        ...
        "근거가 팽팽하면 50/50·55/45라고 정직하게 쓰세요. 억지로 벌리거나 정밀해 보이려 끝자리를 꾸미지 마세요 — "
